  ...
  return (
    <footer>
      <div class="footer-btm border-top">
        <div class="ftr-btn">
          <Link to={'/myPage'} class={`link  ${location.pathname == '/myPage' ? 'active' : ''} `}>
            <span class="ico-blk">
              <img src="/images/home-btm-ico.svg" alt="ico" />
            </span>
            <p>{t('Footer.My Page')}</p>
          </Link>
          <Link to={'/election'} class={`link  ${location.pathname == '/election' ? 'active' : ''} `}>
            <span class="ico-blk">
        ...
        <div class="ftr-btn">
          <Link to={'/newElection'} class={`link  ${location.pathname == '/newElection' ? 'active' : ''} `}>
            <span class="ico-blk">
              <img src="/images/election-add-btm-ico.svg" alt="" />
            </span>
            <p>{t('Footer.Add Election')}</p>
          </Link>
          <Link to={'/customers'} class={`link  ${location.pathname == '/customers' ? 'active' : ''} `}>
            <span class="ico-blk">
