            ...
            <div class="filter-sidebar head-dd main-menu show">
              ...
              <div class="filter-cont">
                <ul class="dropdown-menu">
                  ...
                  {(user?.login_as == "manual" ||
                    user?.login_as == "google" ||
                    user?.login_as == "facebook") && (
                    <>
                      <li>
                        <Link class="dropdown-item" to={"/userProfile"}>
                          <span class="d-flex align-items-center">
                            {t("Menus.My User Page")}
                          </span>
                          <img
                            class="arrow"
                            src="images/arrow_back_ios-24px.svg"
                  ...
                  <li>
                    <a
                      class="dropdown-item"
                      data-bs-toggle="modal"
                      data-bs-target="#how-it-modal-1"
                    >
                      <span class="d-flex align-items-center">
                        {t("Menus.Third-Party Licenses")}
                      </span>
                      <img class="arrow" src="images/arrow_back_ios-24px.svg" />
                    </a>
                  </li>
                          ...
                          return (
                            ...
                            >
                              <button
                                ...
                                onClick={() =>
                                  Searchftn(item.keyword, item.type)
                                }
                              >
                                <img
                                  class="img-fluid"
                                  src="images/clock_icon_history.svg"
                                  alt=""
                                />{" "}
                              ...
                              <img
                                class="img-fluid"
                                src="images/arrow_up_history.svg"
                                alt=""
                              />
                            </li>
                          );
                  ...
                  return (
                    ...
                    >
                      <div class="img-wrap">
                        <img
                          class="img-fluid"
                          src={item?.picture ? item?.picture : around}
                          alt="img"
                        />
                      </div>
                      <p>{item.name}</p>
            ...
            <div class="privacy-wrapper">
              <div class="container">
                <div class="col-12 privacy-sec">
                  <img
                    src="images/privacy1-img.png"
                    alt="Privacy"
                    class="img-fluid mt-5"
                  />
                  <h3>{t("privacy.Vote and Fun privacy is very simple!!!")}</h3>
                  <p>
                    {t("privacy.We use only your")}{" "}
                    <strong>{t("privacy.email - password")}</strong>
                    {t("privacy.to recognice you, your")}{" "}
                    <strong>{t("privacy.position")}</strong>
                    {t(
                    ...
                    <br />
                    {t(
                      "privacy.if you win a FREE GIFT that can be shipped to you, it may"
                    )}{" "}
                    <br />
                  ...
                  <h4>
                    {t(
                      "privacy.NO OTHER SENSITIVE DATA ARE SAVED SHARED OR USED!!!"
                    )}
                  </h4>
                  <h6 class="text-center">
                    {t(
                      "privacy.We do not monitor your phone, computer, tablet, etc. We do not monitor your life!!!"
                    )}
                  </h6>
                </div>
                <div class="privacy-main-img">
                  <img
                    src="images/privacy2-img.png"
                    alt="Privacy"
                    class="img-fluid privacy-badge"
                  />
          ...
          <div class="modal-content">
            <div class="privacy-wrapper">
              <div class="container">
                <div class="col-12 privacy-sec">
                  <img
                    src="images/how-does-badge.svg"
                    alt="How Does It Work"
                    class="img-fluid mt-5 mb-2"
                  />
                  {!howDoesitWork ? (
                    <>
                      <div class="cont-hiw">
                        ...
                        <div class="cont-rgt">
                          ...
                          <p>
                            ...
                            <img
                              ...
                              src="images/join-candidate-b-ico.svg"
                              alt="ico"
                            />
                          </p>
                        </div>
                      ...
                      <div class="cont-hiw">
                        ...
                        <div class="cont-rgt">
                          ...
                          <p>
                            ...
                            <img
                              class="img-fluid border"
                              src="images/ask-vote-b-ico.svg"
                              alt="ico"
                            />
                            {t(
                              "does_work.to share the link of your page and ask people to vote you!!!"
                            )}
                          </p>
                        </div>
                      </div>
                      <div class="cont-hiw">
                        ...
                        <div class="cont-rgt">
                          <h5>
                            {t(
                              "does_work.COLLECT VOTEs FROM THE BUSINESS PLACE"
                            )}
                          </h5>
                          <p class="img-right">
                            {t(
                    ...
                    <video
                      src={
                        "http://54.255.52.195/uploads/business/video/10add839cf2e83a907eafb542eef9458d8f3f890.mp4"
                      }
                      controls="controls"
                      width={"95%"}
                      class="mt-5 m-2"
                ...
                <div class="static-btm">
                  <button
                    ...
                    onClick={() => sethowDoesitWork(false)}
                  >
                    <img
                      class="img-fluid"
                      src="images/close-x.svg"
                  ...
                  {!howDoesitWork && (
                    <button
                      onClick={() => sethowDoesitWork(!howDoesitWork)}
                      className="bg-transparent border-0"
                    >
          ...
          <div class="modal-content">
            <div class="privacy-wrapper">
              <div class="container">
                <div class="col-12 privacy-sec">
                  <img
                    src="images/third-party-skew-bg.svg"
                    alt="How Does It Work"
                    class="img-fluid mt-2 mb-2"
                  />
