...
export default function GiveVote({ setVoteScreen, VoteScreen, candidate_id, election_id, VisitorVoteAdd }) {
  ...
  return (
    <div>
      <TopHeader title={t('Header.Give a Vote')} backarrow={true} backarrowftn={() => setVoteScreen(false)} />
      {loader && <Loader />}
      <section class="content-sec row">
        <div class="vote-sec px-0">
          <img class="w-100 img-fluid" src="images/vote-base-bg.svg" alt="ico" />
            ...
            <div class="winner-sec">
              ...
              <div class="winner-badge">
                <div class="badge-cont">
                  ...
                  <h6>{rank?.username}</h6>
                  <p>
                    <img src="images/vote-ico.svg" alt="ico" /> {rank?.vote_count}
                  </p>
                </div>
                <img class="img-fluid" src="images/winner-badge-trimmed.png" alt="image" />
              </div>
            </div>
          ) : (
            <div class="winner-sec">
              ...
              >
                <img src={rank?.avatar ? rank?.avatar : 'images/avatar-big-1.png'} alt="username" />
              </div>
              <div class="winner-badge">
                <div class="badge-cont">
                ...
                <img class="img-fluid move-up" src="images/not-winner-badge.png" alt="image" />
              </div>
            </div>
          )}
        ...
        <div class="product-wrap ">
          ...
          {rank?.rankings?.map((item, index) => {
            return (
              <div
                key={index}
                class={`candidate-snippet m-0 w-100 ${item.candidate_id == rank.candidate_id ? 'bordered' : ''} `}
              >
                <div
                  class="user-img"
                  onClick={() =>
                ...
                >
                  <img src={item?.avatar ? item?.avatar : 'images/avatar-img-2.png'} alt="Name" />
                </div>
                <div class="avatar-cont">
                  <div class="ac-lft">
                    ...
                    <ProgressBar
                      ...
                      remaining={
                        rank?.rankings && parseInt(rank?.rankings[0]?.votes_count) - parseInt(item?.votes_count)
                      }
                    />
                  </div>
